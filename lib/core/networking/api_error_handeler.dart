...
// }
  ApiErrorModel getFailure() {
    switch (this) {
      case DataSource.NO_CONTENT:
        return ApiErrorModel(
            message: ResponseMessage.NO_CONTENT, status: false, data: null);
      case DataSource.BAD_REQUEST:
        return ApiErrorModel(
            message: ResponseMessage.BAD_REQUEST, status: false, data: null);
      case DataSource.FORBIDDEN:
        return ApiErrorModel(
            message: ResponseMessage.FORBIDDEN, status: false, data: null);
      case DataSource.UNAUTORISED:
        return ApiErrorModel(
            message: ResponseMessage.UNAUTORISED, status: false, data: null);
      case DataSource.NOT_FOUND:
        return ApiErrorModel(
            message: ResponseMessage.NOT_FOUND, status: false, data: null);
      case DataSource.INTERNAL_SERVER_ERROR:
        return ApiErrorModel(
            message: ResponseMessage.INTERNAL_SERVER_ERROR,
            status: false,
      ...
      case DataSource.CANCEL:
        return ApiErrorModel(
            message: ResponseMessage.CANCEL, status: false, data: null);
      case DataSource.RECIEVE_TIMEOUT:
        return ApiErrorModel(
            message: ResponseMessage.RECIEVE_TIMEOUT,
            status: false,
      ...
      case DataSource.SEND_TIMEOUT:
        return ApiErrorModel(
            message: ResponseMessage.SEND_TIMEOUT, status: false, data: null);
      case DataSource.CACHE_ERROR:
        return ApiErrorModel(
            message: ResponseMessage.CACHE_ERROR, status: false, data: null);
      case DataSource.NO_INTERNET_CONNECTION:
        return ApiErrorModel(
            message: ResponseMessage.NO_INTERNET_CONNECTION,
            status: false,
      ...
      case DataSource.DEFAULT:
        return ApiErrorModel(
            message: ResponseMessage.DEFAULT, status: false, data: null);
    }
  }
}
